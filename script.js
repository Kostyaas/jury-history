const cases = [
  ...
  {
    id: "morozov-strike",
    title: "Дело участников Морозовской стачки",
    year: "1886",
    place: "Владимир",
    tag: "Рабочий вопрос",
    cardText:
      "Рабочих Никольской мануфактуры судили после крупной забастовки. На процессе открылись тяжелые условия труда, и присяжные оправдали подсудимых.",
    summary:
      "После Морозовской стачки перед судом оказались рабочие Никольской мануфактуры. Формально их обвиняли в участии в беспорядках и подстрекательстве, но процесс превратился в обсуждение фабричных штрафов, тяжелого положения рабочих и ответственности администрации.",
    brief: {
      story:
        "В январе 1885 года на Никольской мануфактуре Морозовых началась одна из крупнейших рабочих забастовок Российской империи. Рабочие протестовали против штрафов, низкой оплаты и тяжелых условий. После подавления стачки часть участников оказалась на скамье подсудимых, но в суде стало ясно, что конфликт вырос из реальных злоупотреблений фабричной администрации.",
      people:
        "Среди обвиняемых были рабочие Никольской мануфактуры, в том числе Петр Моисеенко и Василий Волков. На другой стороне фактически оказались фабричная администрация и власти, подавлявшие стачку.",
      context:
        "1880-е годы стали временем роста рабочего вопроса в России. Морозовская стачка повлияла на обсуждение фабричного законодательства, особенно правил о штрафах.",
      coreQuestion:
        "Должны ли присяжные судить рабочих только за беспорядки или учитывать условия труда, штрафы и действия фабричной администрации?"
    },
    prosecution: [
      "Рабочих обвиняли в участии в беспорядках и нарушении общественного порядка.",
      "Обвинение видело в стачке угрозу фабричной дисциплине и государственной власти.",
      "Организаторов пытались представить как подстрекателей, которые вывели конфликт за рамки законного протеста."
    ],
    defense: [
      "Рабочие протестовали против тяжелых условий, штрафов и злоупотреблений администрации.",
      "На процессе выяснилось, что фабричные порядки сами провоцировали конфликт.",
      "Присяжные должны были учитывать социальную причину стачки, а не только формальные обвинения."
    ],
    questions: [
      "Можно ли признать рабочих виновными, если протест был вызван реальным бесправием?",
      "Должен ли суд учитывать поведение фабричной администрации?",
      "Где проходит граница между преступным беспорядком и социальным протестом?"
    ],
    historicalVerdict: "Оправдательный вердикт",
    resultText:
      "На втором процессе по делу участников Морозовской стачки присяжные оправдали рабочих. Гласный суд показал обществу тяжелые фабричные порядки и сделал рабочий вопрос заметным для всей страны.",
    impact:
      "Дело важно тем, что суд присяжных оказался местом, где социальный конфликт был рассмотрен публично, а не только как нарушение порядка.",
    correctVerdict: "not-guilty"
  },
  {
    id: "kronenberg",
